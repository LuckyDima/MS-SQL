...
--## USAGE: find replace idimas@i-free.com with your email address then run on msdb
--##############################################################
...
@pager_days=127, 
@email_address=N'idimas@i-free.com', 
...
SET @Threshold_UnsentLogSize= 10240;--#### In KB
SET @Threshold_UnrestoredLogSize= 10240;--#### In KB
