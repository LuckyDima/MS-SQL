...
where 
auto_created = 1 and /*статистика создана автоматически*/

 ao.type = N'U' /*статистика создана пользователем*/
--and no_recompute = 1 /*статистика не обновляется автоматом*/
...
---------------- Удаление гипотетических индексов------------------------------------
