--Проверка доступности snapshot-а, если попадаем на время его создания\удаления, то ждем 4 секунды
...
WAITFOR DELAY '00:00:04'
  --RAISERROR('Пересоздается Snapshot. Необходимо подождать!', 16, 2 );
	END
