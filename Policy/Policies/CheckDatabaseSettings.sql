...
EXEC msdb.dbo.sp_syspolicy_add_object_set @object_set_name = N'Check database settings_ObjectSet',
                                          @facet = N'Database',
                                          @object_set_id = @object_set_id OUTPUT;
SELECT @object_set_id;

DECLARE @target_set_id INT;
EXEC msdb.dbo.sp_syspolicy_add_target_set @object_set_name = N'Check database settings_ObjectSet',
...
EXEC msdb.dbo.sp_syspolicy_add_policy @name = N'Check database settings',
                                      @condition_name = N'Check database settings NOT PROD',
